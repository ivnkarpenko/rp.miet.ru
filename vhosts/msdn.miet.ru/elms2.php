...
<td id="main" align="center">
    ...
    <tr><td align="center"><img src="logo.png"></td></tr>
...
if ($_REQUEST['auth'] == 'Y')
{
  ...
  if ($cpt->CheckCode($_REQUEST['secret_number'], $_REQUEST['captcha_sid'])):
    ...
    $link = ldap_connect("82.179.184.111", "389");
...
<form method="post" target="_top" action="elms2.php">
    ...
    <table align="center" style="width: 70%; margin-top: 10px;">
            <tr>
                <td align="center"><input  class="all default login_input" type="text" name="USER_LOGIN" maxlength="50" value="Логин" size="25" data-default="Логин" /></td>
            </tr>
            <tr>
                <td align="center">
                <input id="fake_password_input" type="text" class="all  default" value="Пароль" style="display: inline-block;">
                <input id="password_input" type="password" name="USER_PASSWORD" class="all " style="display: none;" value="">                
            </tr>
            <tr>                
            ...
            <tr>
                ...
                <td  align="center"><input class="all default login_input"  type="text" name="secret_number" maxlength="5" value="Введите код" size="25" data-default="Введите код" /></td>
            </tr>



            <tr >
                <td  align="center" colspan="1" style="padding-top: 10px;"><input type="submit" class="enter" value="Вход" /></td>
            </tr>
